...
let heroInfoJSON = JSON.stringify(heroInfo);
let personalDetailJSON = JSON.stringify(personalDetail);
let projectsJSON = JSON.stringify(projects);
 
localStorage.setItem("heroInfo", heroInfoJSON);
localStorage.setItem("personalDetail", personalDetailJSON);
...
let parsedPersonalDetail = JSON.parse(storedPersonalDetail);
let parsedProjects = JSON.parse(storedProjects);


console.log(parsedHeroInfo.name);
